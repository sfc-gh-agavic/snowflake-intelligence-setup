...
GRANT REFERENCES, SELECT ON FUTURE SEMANTIC VIEWS IN SCHEMA SNOWFLAKE_INTELLIGENCE.SERVICES TO ROLE SNOWFLAKE_INTELLIGENCE_ADMIN; -- grant references, select on future semantic views to SI ADMINS
